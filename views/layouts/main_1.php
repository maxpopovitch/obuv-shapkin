                ...
                <div class="row row-offcanvas row-offcanvas-right">
                    ...
                    <?php if (Yii::$app->user->isGuest || strpos(Url::current(), 'admin') === false) { ?>
                        ...
                        foreach ($wares as $ware) {
                            ($ware->new_price > 0) ? array_push($prices, $ware->new_price) : array_push($prices, $ware->init_price);
                        }
                        echo '<pre>';
                        yii\helpers\VarDumper::dump($prices);
                        echo '</pre>';
                        ?>
                        <?php
                        $form = ActiveForm::begin([
                                    'id' => 'oc-details-form',
                                    'action' => 'index.php?r=site%2Findex',
                                    'method' => 'POST'
                        ]);
                        ?>
                            ...
                            <div class="row">
                                <div class="oc-details-grid">
                                    <div class="oc-cat-div">
                                        ...
                                        ?>
                                        <span>от&nbsp;</span><b><span><?= min($prices) ?></span></b>&nbsp;до&nbsp;<b><span id="oc-max-price-val"><?= max($prices) ?></span><span>&nbsp;грн.</span></b>
                                    </div>
                                    ...
                                    <div class="oc-cat-div">
                                        ...
                                        <div>
                                            ...
                                            <label for="oc-width-f-5" class="oc-details-label">F&frac12;
                                            </label>
                                        </div>
                                        <div>
